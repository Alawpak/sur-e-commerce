...
const rawProducts: Product[] = [
  ...
  },
  {
    ...
    description:
      "Tapered jogger that reads street, performs like training kit.",
    price: 195,
    currency: "EUR",
    sizes: ["S", "M", "L", "XL"],
  ...
  },
  {
    ...
    slug: "field-cap",
    sku: "SUR-CAP_FIELD_OS",
    imageUrl: "/products/DSC00884.jpg",
    description: "Unstructured corduroy cap. One size, every session.",
    price: 75,
    currency: "EUR",
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    slug: "field-cap",
    sku: "SUR-CAP_FIELD_OS",
    imageUrl: "/products/DSC01452.jpg",
    description: "Unstructured corduroy cap. One size, every session.",
    price: 75,
    currency: "EUR",
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    slug: "field-cap",
    sku: "SUR-CAP_FIELD_OS",
    imageUrl: "/products/DSC00822.jpg",
    description: "Unstructured corduroy cap. One size, every session.",
    price: 75,
    currency: "EUR",
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    slug: "field-cap",
    sku: "SUR-CAP_FIELD_OS",
    imageUrl: "/products/DSC02094.jpg",
    description: "Unstructured corduroy cap. One size, every session.",
    price: 75,
    currency: "EUR",
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    slug: "field-cap",
    sku: "SUR-CAP_FIELD_OS",
    imageUrl: "/products/DSC01123.jpg",
    description: "Unstructured corduroy cap. One size, every session.",
    price: 75,
    currency: "EUR",
    sizes: ["S", "M", "L"],
  ...
  },
  {
    ...
    slug: "field-cap",
    sku: "SUR-CAP_FIELD_OS",
    imageUrl: "/products/DSC01231.jpg",
    description: "Unstructured corduroy cap. One size, every session.",
    price: 75,
    currency: "EUR",
    sizes: ["S", "M", "L"],
...
const photoPool = [
  ...
  "/products/DSC00884.jpg",
  "/products/DSC01452.jpg",
  "/products/DSC00822.jpg",
  "/products/DSC02094.jpg",
  "/products/DSC01123.jpg",
  "/products/DSC01231.jpg",
];
